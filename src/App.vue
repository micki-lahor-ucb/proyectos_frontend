    ...
    <header v-if="isAuthenticated" class="bg-white shadow">
      ...
      >
        <div class="flex flex-col md:flex-row items-center mb-4 md:mb-0">
          <h1 class="text-xl font-bold text-blue-600 mb-2 md:mb-0">
            ProjectManager
          </h1>
          <div
            class="md:ml-6 space-y-2 md:space-y-0 md:space-x-4 text-center md:text-left"
          >
            <router-link
              class="block md:inline-block text-gray-600 hover:text-blue-600"
              to="/"
              >Inicio</router-link
            >
            <router-link
